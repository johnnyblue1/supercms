...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-fw fa-thumb-tack"></i> Lista artykułów
            </li>
        </ol>
    </div>
</div>
...
<?php if(!empty($blog)): ?>
	...
	<?php foreach($blog as $row): ?>
		<tr>
			...
			<td><?php echo anchor('admin/blog/edit/' . $row->id, '<button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></button>'); ?></td>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
               ...
               <div class="alert alert-danger">Jesteś pewien, że chcesz usunąć</br><strong><?php echo ($row->title); ?></strong> ?</div>
                ...
                <?php echo anchor('admin/blog/delete/' . $row->id, '<button class="btn btn-success" >Tak</button>'); ?></td>
